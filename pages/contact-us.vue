            ...
            <div class="-mx-4 flex flex-wrap">
                <div class="mx-auto px-4 rounded-2xl w-full lg:w-8/12">
                    <div class="px-6 py-12 rounded-lg tertiary-card">
                        ...
                        <p class="mb-8">
                            Inscreva-se em nosso Newsletter para receber atualizações e ofertas exclusivas
                        </p>
                        <form class="mx-auto sm:w-9/12 xl:w-8/12"
                            action="https://www.getdrip.com/forms/243852739/submissions" method="post" target="_blank"
                            rel="noopener" data-drip-embedded-form="243852739">
                            <div class="flex items-center overflow-hidden p-2 rounded-full">
                                <label for="emailfield" class="sr-only">Endereço de Email:</label>
                                <input id="emailfield"
